...
export default function Testinomials() {
  return (
    <div>
    <div className=' flex mx-auto w-[85vw] h-[80vh] items-center justify-between mb-5 '>
      <div className='h-full py-[4rem] w-[15rem] flex flex-col justify-between '>
      ...
      <div className='w-[477px] md:border-b-[1px]  border-primary h-[573px] relative flex items-center justify-center'>

        <img src={womanimg} alt="" className=' md:w-[477px] md:h-[573px] z-30 relative  md:block'/>
        <div className='bg-primary w-[30rem] aspect-square rounded-full absolute top-[55px] z-0 sm:hidden hidden md:block'></div>
      </div>
      <div className='h-full py-[4rem]  flex flex-col justify-between m,'>
        <div className='border-b-[1px] md:w-[15rem] p-6 border-primary'>
      ...
      <div>
       ...
       <div className=' w-screen  flex flex-col item-center justify-between mt-[25px]'>
